...
export default function RosterDisplay({ players }: RosterDisplayProps) {
  if (players.length === 0) {
    return (
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      <h2 className="text-2xl font-bold mb-4">Roster ({players.length} players)</h2>
              ...
              <tr key={player.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                  <div className="flex flex-col space-y-1">
                    ...
                    {!player.is_captain && !player.is_player_coach && (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {player.twitter_id && (
                      <a
                        ...
                        title={`Twitter: @${player.twitter_id}`}
                      >
